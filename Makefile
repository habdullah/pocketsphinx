...
ACLOCAL = ${SHELL} /media/t-rex/F/sphinx/cmusphinx-en-us-5.2/pocketsphinx/missing aclocal-1.15
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 1
AR = ar
AUTOCONF = ${SHELL} /media/t-rex/F/sphinx/cmusphinx-en-us-5.2/pocketsphinx/missing autoconf
AUTOHEADER = ${SHELL} /media/t-rex/F/sphinx/cmusphinx-en-us-5.2/pocketsphinx/missing autoheader
AUTOMAKE = ${SHELL} /media/t-rex/F/sphinx/cmusphinx-en-us-5.2/pocketsphinx/missing automake-1.15
AWK = gawk
CC = gcc
CCDEPMODE = depmode=gcc3
CFLAGS = -g -O2 -Wall
CPP = gcc -E
CPPFLAGS =  -I/usr/local/include -I/usr/local/include/sphinxbase
CYGPATH_W = echo
DEFS = -DHAVE_CONFIG_H
DEPDIR = .deps
DLLTOOL = false
...
LTLIBOBJS = 
LT_SYS_LIBRARY_PATH = 
MAKEINFO = ${SHELL} /media/t-rex/F/sphinx/cmusphinx-en-us-5.2/pocketsphinx/missing makeinfo
MANIFEST_TOOL = :
MKDIR_P = /bin/mkdir -p
NM = /usr/bin/nm -B
NMEDIT = 
...
SET_MAKE = 
SHELL = /bin/bash
SPHINXBASE_CFLAGS = -I/usr/local/include -I/usr/local/include/sphinxbase
SPHINXBASE_LIBS = -L/usr/local/lib -lsphinxbase -lsphinxad -lpulse -lpulse-simple -lpthread -lm
SPHINXBASE_SWIG = /usr/local/share/sphinxbase/swig
STRIP = strip
SWIG = /usr/bin/swig
SWIG_LIB = /usr/share/swig3.0
VERSION = 5prealpha
abs_builddir = /media/t-rex/F/sphinx/cmusphinx-en-us-5.2/pocketsphinx
abs_srcdir = /media/t-rex/F/sphinx/cmusphinx-en-us-5.2/pocketsphinx
abs_top_builddir = /media/t-rex/F/sphinx/cmusphinx-en-us-5.2/pocketsphinx
abs_top_srcdir = /media/t-rex/F/sphinx/cmusphinx-en-us-5.2/pocketsphinx
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_DUMPBIN = 
am__include = include
...
install_sh = ${SHELL} /media/t-rex/F/sphinx/cmusphinx-en-us-5.2/pocketsphinx/install-sh
